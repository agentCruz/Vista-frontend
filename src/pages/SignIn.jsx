...
export default function SignIn() {
  ...
  const handleSignUp = async (e) => {
    e.preventDefault();
    try {
     signUp(email, password, username).then(() => navigate("/"));
  ...
  return (
    <form className="p-6">
      ...
      <div className="flex items-center mt-1">
        ...
        <p className="text-sm">
          I agree to the{" "}
          <Link to="#" className="text-[#7856FF] underline">
      ...
      <div className="flex flex-col text-center gap-4 mt-12">
        ...
        <button
          className="w-full text-[#7856FF] bg-[#F8F8F8] rounded-lg py-[16px] font-semibold"
          onClick={() => navigate("/")}
        >
          Login
        </button>
