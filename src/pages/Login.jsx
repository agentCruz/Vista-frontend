...
export default function Login() {
  ...
  return (
    <main className='p-6 mx-auto max-w-[600px]'>
      ...
      <h1 className='mt-6 font-bold text-[#283079] text-[40px]'>Welcome back to Vista! </h1>
      {/* Inputs */}
      ...
      {/* button */}
      <button onClick={handleLogin} className='w-full bg-[#7856FF] text-[white] rounded-lg py-[16px] mt-12 font-semibold'>
        Login
      </button>
      {/* No account */}
